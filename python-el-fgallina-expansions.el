...
delimiters as well."
  (let ((beginning-of-string (call-obsolete-function python-info-ppss-context python-syntax-context "24.3" 'string (syntax-ppss))))
    (when beginning-of-string
      ...
      (while (call-obsolete-function python-info-ppss-context python-syntax-context "24.3" 'string (syntax-ppss))
        (forward-char 1))
  ...
  (let ((next-indent-level
         (or
          ...
          (if (looking-at er--python-block-start-regex)
              ...
              (+ (current-indentation) (use-obsolete-variable python-indent python-indent-offset "24.3"))
